...
**💰 돈 액수 절대 금지 (광고심의 위험):**
- 보험금·보장 금액을 구체 액수로 표현 X: "수백만 원", "월 50만 원", "1억 원", "3천만 원"
- 보험료 액수 X: "월 5만 원", "연 60만 원"
- 대신 **상대 비율**(약 30% ↓), **횟수**(연 1회), **등급**(CDR 1점), **개념어**(NEW, 비급여 ↓) 사용
- bigStat 예시 OK: "30% ↓", "약 2배", "NEW", "비급여 ↓", "1점 차이"
- bigStat 예시 NO: "수백만 원", "월 30만 원", "1억"
`;
