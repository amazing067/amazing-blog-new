...
export interface QAPromptData {
  ...
  answerLength?: 'short' | 'default' // 답변 길이: 'short' (150-250자) | 'default' (300-700자)
...
${ageToneGuide}
   ...
   - **일반인 톤 유지**: 전문가처럼 보이지 않되, 오타나 구어체를 과도하게 사용하지 않음
   - **정확한 맞춤법 사용**: 맞춤법과 띄어쓰기를 정확하게 사용
   - **정중한 표현**: "~요" 체를 사용하여 정중하게 표현
   - **물음표 사용**: 질문 형식에 자연스럽게 물음표 사용 (예: "괜찮은가요?", "가능한가요?")
...
7. **본문 규칙 (매우 중요 - 정돈된 형식으로 디테일하게 작성!)**:
   - **500-800자 내외로 충분히 상세하게 작성하세요** (기존 200-400자에서 대폭 증가)
   - **정돈된 형식 유지**: 전문가 답변처럼 문단 구분을 명확히 하되, 일반인이 쓴 것처럼 자연스럽게
   - **문단 구분 필수**: 본문을 3-4개의 문단으로 나누어 작성하세요 (각 문단 사이 빈 줄 추가)
   ...
   - **질문 구조 예시 (정돈된 형식 - 개인적 경험 포함, 문단 구분)**:
     * "${age}세 ${gender === '남' ? '남성' : '여성'} 직장인입니다 최근 주변에서 연금보험 가입을 권하는 분들이 많아서 관심을 갖게 되었어요 금리가 변동이 심해서 노후 준비를 어떻게 해야 할지 고민이 많았는데요

제안서를 받아보니 KB 트리플 레벨업 연금보험 무배당(보증형)이라는 상품이 월 50만원으로 구성되어 있더라고요 보험료가 좀 부담스러운 편인데 85세까지 유지해야 하다고 하더라고요

친구가 연금보험 가입했다가 원금 손실을 본 이야기를 들어서 걱정이 됩니다 이 상품이 정말 필요한지, 현재 5년 정도만 납입하고 유지하면 되는지 궁금합니다 조기 해지 시 손실이 큰지도 알고 싶어요

혹시 다른 보험사 연금보험 상품 중에 비교해볼 만한 게 있으시면 추천 부탁드립니다"
...
예시 1 (정돈된 형식 - 차갑고 거리감 있는 스타일):
제목: "35세 여성 NH농협손해보험 3대 중대질병 진단보험 질문드려요"
본문: "35세 여성입니다 저랑 비슷한 또래 사촌이 갑자기 암진단을 받아서 가족 모두가 크게 놀란 일이 있었어요 병원비와 치료 일정 때문에 온 가족이 분주해지는 걸 보니까 저도 암진단비 준비를 더 이상 미루면 안 되겠다 싶더라고요

현재는 실손보험만 있고요 질병 이력 없고 입원/수술 경험 없고 건강한 30대 여성입니다 올해 안에 3대 중대질병(암, 뇌, 심장) 진단보험 준비하려고 하는데요 더 늦으면 보험 가입이 어려울 수도 있어서 지금 준비하려고요

NH농협손해보험 설계서를 하나 받아봤는데 월보험료가 적당한 수준으로 구성되어 있더라고요 ${productName}이 30대 여성에게 최적인지 궁금합니다 같은 보장에 최저 보험료를 원합니다

미래를 위한 거라서 보험료가 너무 비싸면 부담스러워서요 이 설계안 봐주시고 의견 주시면 감사하겠습니다"

예시 2 (정돈된 형식 - 간결하고 직설적인 스타일):
제목: "20대 골절보험 적정한가요?"
본문: "20대라서 큰 병은 잘 생각 안 하고 살았는데 주변에서 골절로 깁스하거나 수술을 하는 경우를 보니까 저도 골절 쪽 보장은 챙겨야겠다는 생각이 들었어요 특히 운동을 자주 하다 보니 손목이나 발목 같은 작은 골절은 언제 생길지 모르겠다는 생각이 들어서요

20대 골절 보장을 알아보다가 제안서를 하나 받아봤는데 월보험료가 1만원대로 부담없게 구성되어 있더라고요 그런데 보장 중에 10대골절진단비 200만원, 10대골절수술비, 그리고 일반골절진단비, 골절수술비까지 포함된 걸 보고 이렇게 가입하면 상해보험 괜찮은지 궁금해졌습니다

보험료가 저렴한 편이라서 구성 자체는 괜찮아 보이는데 20대 기준으로 10대골절진단비 200만원 정도면 충분한지 아니면 더 높여야 하는지 잘 모르겠습니다 골절사고가 생각보다 다양하고 작은 골절도 은근히 비용이 나간다고 들었거든요

혹시 20대 골절진단비 구성하신 분들이나 관련해서 잘 아시는 분들 진단비 위주로 잡는 게 좋은지 골절 수술비 비중을 더 두는 게 맞는지 월 1만원대 구성으로 충분한지 이 부분에 대해 의견 주시면 정말 도움이 될 것 같아요"

예시 3 (정돈된 형식 - 궁금해서 물어보는 스타일):
제목: "체증형이 일반 암진단비에도 적용되나요?"
본문: "35세 여성입니다 주변에서 암 진단을 받은 분들이 치료비 때문에 힘들어하는 걸 보니까 저도 암보험을 준비해야겠다는 생각이 들었어요 현재 실손보험과 암보험은 있는데 중대질병보험은 없어서요

건강검진 받았는데 특이사항 없었고 평소 건강하게 지내고 있어요 올해 안에 3대 중대질병 진단보험 준비하려고 하는데 ${productName} 설계서를 하나 받아봤는데요

유사암 체증형이 일반 암진단비에도 적용되는지 궁금해요 항암약물치료가 연간 1회씩 10년간 보장되는지도 알고 싶어요 중입자치료가 암주요치료비 특약에 포함되는지도 궁금하고요

같은 보장인데 보험료가 더 저렴한 게 있을까요? 이 설계안 봐주시고 조언 부탁드립니다"
...
- 제어 문자 사용
- 한 문단에 모든 내용 압축 (문단 구분을 명확히 하여 정돈된 형식 유지)
- **마침표(.) 사용 (절대 금지! 문장 끝에 마침표를 사용하지 마세요)**
- 모호한 질문 (구체적 금액, 조건, 담보명을 명확히 언급)
- 과도한 오타나 구어체 사용 (정돈된 형식 유지)
- 문단 구분 없이 한 덩어리로 작성 (반드시 3-4개 문단으로 나누어 작성)

**문단 구분 형식 가이드 (매우 중요!)**:
- 각 문단 사이에는 반드시 빈 줄(줄바꿈 2개)을 넣어주세요
- 첫 문단: 나이/성별 소개 + 배경 상황
- 두 번째 문단: 현재 상태 또는 설계서 언급
- 세 번째 문단: 구체적 질문 또는 고민사항
- 네 번째 문단: 비교 요청 또는 조언 요청
- 각 문단은 2-3문장 정도로 적절한 길이를 유지하세요`
...
export function generateAnswerPrompt(data: QAPromptData, questionTitle: string, questionContent: string): string {
  const { productName, sellingPoint, answerTone, feelingTone, targetPersona, designSheetAnalysis, customerStyle, answerLength, searchResultsText } = data
...
export function generateReviewMessagePrompt(
  ...
  // 다양한 후기성 문구 패턴 (매우 다양하게, 항상 친절하고 자세하게, 구체적 정보 포함)
  const reviewPatterns = [
    // 패턴 1: 가입 완료 + 상세한 감사 (구체적 정보 포함)
    {
      type: '가입 완료 + 상세한 감사 (구체적 정보 포함)',
      examples: [
        '여기서 보험 가입했는데 이렇게 가입시켜줘서 정말 고맙습니다',
        '설계사님 덕분에 ${age}세 ${gender === "남" ? "남성" : "여성"}에게 딱 맞는 ${productName} 가입할 수 있어서 정말 든든하네요 여기서 보험 가입했는데 이렇게 가입시켜줘서 정말 고맙습니다',
        '설계사님 덕분에 잘 가입했어요 처음부터 끝까지 친절하게 설명해주셔서 감사합니다 ${productName}이 ${age}대 ${gender === "남" ? "남성" : "여성"}에게 적합한 상품이어서 만족합니다',
        '여기서 가입했는데 설명 잘 해주셔서 고맙습니다 궁금한 점마다 하나하나 자세히 답변해주셔서 정말 감사합니다 ${age}세 ${gender === "남" ? "남성" : "여성"}에게 맞는 ${productName} 가입하게 되어서 든든합니다',
        '${productName} 가입했는데 이렇게 친절하게 설명해주셔서 감사합니다 보험료부터 보장 내용까지 자세히 알려주셔서 이해하기 쉬웠어요 ${age}대 ${gender === "남" ? "남성" : "여성"}에게 딱 맞는 상품이어서 만족합니다',
        '설계사님 추천대로 가입했는데 정말 만족스러워요 처음 질문할 때부터 가입까지 전 과정이 만족스러웠습니다 ${productName}이 ${age}세 ${gender === "남" ? "남성" : "여성"}에게 적합한 보장이어서 좋습니다',
        '여기서 보험 가입했는데 친절하게 도와주셔서 고맙습니다 설명이 자세해서 보험에 대해 잘 이해할 수 있었어요 ${age}대 ${gender === "남" ? "남성" : "여성"}에게 맞는 ${productName} 가입하게 되어서 든든합니다'
      ]
    },
    // 패턴 2: 만족도 + 상세한 표현 (구체적 정보 포함)
    {
      type: '만족도 + 상세한 표현 (구체적 정보 포함)',
      examples: [
        '설계사님 추천대로 가입했는데 생각보다 좋아서 만족합니다 보험료도 합리적이고 보장도 괜찮아서 정말 좋아요 ${age}세 ${gender === "남" ? "남성" : "여성"}에게 딱 맞는 ${productName}이어서 만족합니다',
        '여기서 가입했는데 보험료도 합리적이고 보장도 괜찮아서 좋아요 설명도 자세해서 이해하기 쉬웠습니다 ${productName}이 ${age}대 ${gender === "남" ? "남성" : "여성"}에게 적합한 상품이어서 좋습니다',
        '가입했는데 설명이 자세해서 이해하기 쉬웠어요 감사합니다 처음에는 복잡해 보였는데 하나하나 설명해주셔서 잘 이해할 수 있었습니다 ${age}세 ${gender === "남" ? "남성" : "여성"}에게 맞는 ${productName} 가입하게 되어서 든든합니다',
        '${productName} 가입했는데 보장 내용도 좋고 보험료도 적당해서 만족합니다 설계사님 덕분에 좋은 보험 가입하게 되어서 고맙습니다 ${age}대 ${gender === "남" ? "남성" : "여성"}에게 딱 맞는 상품이어서 만족합니다',
        '설계사님 덕분에 좋은 보험 가입하게 되어서 고맙습니다 처음 질문할 때부터 가입까지 친절하게 도와주셔서 정말 감사합니다 ${age}세 ${gender === "남" ? "남성" : "여성"}에게 적합한 ${productName}이어서 좋습니다',
        '가입했는데 생각보다 괜찮아서 만족스러워요 보험료 대비 보장이 좋아서 만족합니다 ${productName}이 ${age}대 ${gender === "남" ? "남성" : "여성"}에게 맞는 보장이어서 든든합니다'
      ]
    },
    // 패턴 3: 추천 의도 + 감사
    {
      type: '추천 의도 + 감사',
      examples: [
        '가입했는데 친구한테도 추천해도 될까요? 이 보험 정말 좋아서 주변 사람들한테도 추천하고 싶어요',
        '여기서 가입했는데 주변 사람들한테도 이 보험 추천해도 되나요? 설계사님 덕분에 좋은 보험 가입하게 되어서 고맙습니다',
        '설계사님 덕분에 잘 가입했는데 가족한테도 추천하고 싶어요 이 보험 정말 만족스러워서 주변 사람들한테도 알려주고 싶습니다',
        '가입했는데 이 보험 정말 좋아서 주변에 추천하고 싶은데 괜찮을까요? 보험료도 합리적이고 보장도 좋아서 추천하고 싶어요',
        '여기서 가입했는데 동생한테도 추천해도 될까요? 이 보험 정말 만족스러워서 가족한테도 추천하고 싶습니다',
        '가입 완료했고 친구한테도 이 보험 추천하고 싶은데 괜찮나요? 설계사님 덕분에 좋은 보험 가입하게 되어서 고맙습니다'
      ]
    },
    // 패턴 4: 추가 질문 + 상세한 감사
    {
      type: '추가 질문 + 상세한 감사',
      examples: [
        '가입했는데 한 가지 더 궁금한 게 있어요 설명 잘 해주셔서 고맙습니다',
        '여기서 가입했는데 추가로 질문이 있어서요 처음부터 끝까지 친절하게 설명해주셔서 정말 감사합니다',
        '가입 완료했고 추가로 궁금한 점이 있어서요 궁금한 점마다 하나하나 자세히 답변해주셔서 고맙습니다',
        '${productName} 가입했는데 한 가지 더 물어볼 게 있어요 설명이 자세해서 이해하기 쉬웠어요 감사합니다',
        '가입했는데 설명 듣다 보니 추가로 궁금한 게 생겼어요 처음 질문할 때부터 가입까지 전 과정이 만족스러워서 감사합니다',
        '여기서 가입했는데 가입 후에도 궁금한 점이 있어서요 보험료부터 보장 내용까지 자세히 알려주셔서 고맙습니다'
      ]
    },
    // 패턴 5: 상세한 감사 + 만족도
    {
      type: '상세한 감사 + 만족도',
      examples: [
        '여기서 보험 가입했는데 처음부터 끝까지 친절하게 설명해주셔서 정말 고맙습니다 보험료부터 보장 내용까지 하나하나 자세히 알려주셔서 이해하기 쉬웠어요',
        '설계사님 덕분에 ${productName} 잘 가입했는데 설명이 자세해서 이해하기 쉬웠어요 감사합니다 궁금한 점마다 친절하게 답변해주셔서 정말 만족스러웠습니다',
        '가입했는데 보험료부터 보장 내용까지 하나하나 자세히 설명해주셔서 고맙습니다 처음에는 복잡해 보였는데 설명을 들으니 이해하기 쉬웠어요',
        '여기서 가입했는데 궁금한 점마다 친절하게 답변해주셔서 정말 감사합니다 처음 질문할 때부터 가입까지 전 과정이 만족스러워서 고맙습니다',
        '설계사님 덕분에 좋은 보험 가입하게 되어서 고맙습니다 앞으로도 잘 부탁드려요 설명이 자세해서 보험에 대해 잘 이해할 수 있었습니다',
        '가입했는데 처음 질문할 때부터 가입까지 전 과정이 만족스러워서 감사합니다 보험료도 합리적이고 보장도 좋아서 정말 만족합니다'
      ]
    },
    // 패턴 6: 가입 후기 + 상세한 표현
    {
      type: '가입 후기 + 상세한 표현',
      examples: [
        '여기서 보험 가입했는데 정말 만족스러워요 보험료도 적당하고 보장도 좋아서 좋습니다 설명도 자세해서 이해하기 쉬웠어요',
        '가입했는데 생각보다 훨씬 좋아서 만족합니다 보험료 대비 보장이 좋아서 만족스러워요 설계사님 덕분에 좋은 보험 가입하게 되어서 고맙습니다',
        '${productName} 가입했는데 보장 내용도 좋고 보험료도 합리적이어서 만족합니다 처음부터 끝까지 친절하게 설명해주셔서 정말 감사합니다',
        '여기서 가입했는데 보험료부터 보장 내용까지 자세히 알려주셔서 고맙습니다 설명이 자세해서 보험에 대해 잘 이해할 수 있었어요',
        '가입했는데 이 보험 정말 좋아서 만족스러워요 보험료도 적당하고 보장도 괜찮아서 좋습니다 설계사님 덕분에 잘 가입하게 되어서 감사합니다',
        '설계사님 추천대로 가입했는데 정말 만족스러워요 처음 질문할 때부터 가입까지 전 과정이 만족스러워서 고맙습니다'
      ]
    },
    // 패턴 7: 감사 + 앞으로의 관계 + 장점
    {
      type: '감사 + 앞으로의 관계 + 장점',
      examples: [
        '여기서 보험 가입했는데 이렇게 가입시켜줘서 정말 고맙습니다 ${productName}이 ${age}대 ${gender === "남" ? "남성" : "여성"}에게 딱 맞는 상품이어서 만족합니다 앞으로도 궁금한 점 있으면 문의해도 될까요?',
        '설계사님 덕분에 잘 가입했어요 감사합니다 보험료도 합리적이고 보장도 좋아서 정말 만족합니다 앞으로도 보험 관련해서 궁금한 점 있으면 편하게 물어봐도 되나요?',
        '가입했는데 설명 잘 해주셔서 고맙습니다 ${productName}이 보험료 대비 보장이 좋아서 든든합니다 앞으로도 잘 부탁드려요 궁금한 점 있으면 언제든 문의해도 될까요?',
        '${productName} 가입했는데 이렇게 친절하게 설명해주셔서 감사합니다 보험료도 적당하고 특약 구성도 탄탄해서 만족합니다 앞으로도 보험 관련해서 도움이 필요하면 연락해도 되나요?',
        '여기서 가입했는데 친절하게 도와주셔서 고맙습니다 ${age}세 ${gender === "남" ? "남성" : "여성"}에게 적합한 보장이어서 좋습니다 앞으로도 궁금한 점 있으면 편하게 물어봐도 될까요?',
        '가입 완료했고 정말 만족스러워요 ${productName}이 가성비가 좋아서 만족합니다 앞으로도 보험 관련해서 궁금한 점 있으면 문의해도 되나요?'
      ]
    },
    // 패턴 8: 상세한 후기 + 감사
    {
      type: '상세한 후기 + 감사',
      examples: [
        '여기서 보험 가입했는데 처음 질문할 때부터 가입까지 전 과정이 만족스러워서 감사합니다 보험료부터 보장 내용까지 하나하나 자세히 설명해주셔서 이해하기 쉬웠어요',
        '설계사님 덕분에 ${productName} 잘 가입했는데 설명이 자세해서 이해하기 쉬웠어요 감사합니다 궁금한 점마다 친절하게 답변해주셔서 정말 만족스러웠습니다',
        '가입했는데 보험료부터 보장 내용까지 하나하나 자세히 설명해주셔서 고맙습니다 처음에는 복잡해 보였는데 설명을 들으니 이해하기 쉬웠어요',
        '여기서 가입했는데 궁금한 점마다 친절하게 답변해주셔서 정말 감사합니다 처음부터 끝까지 친절하게 설명해주셔서 고맙습니다',
        '설계사님 덕분에 좋은 보험 가입하게 되어서 고맙습니다 설명이 자세해서 보험에 대해 잘 이해할 수 있었어요 앞으로도 잘 부탁드려요',
        '가입했는데 처음 질문할 때부터 가입까지 전 과정이 만족스러워서 감사합니다 보험료도 합리적이고 보장도 좋아서 정말 만족합니다'
      ]
    }
  ]
...
[이전 대화 맥락]
초기 질문:
제목: ${context.initialQuestion.title}
본문: ${context.initialQuestion.content}
...
${pattern.examples.map((ex, exIdx) => `     ${exIdx + 1}. "${ex.replace(/\$\{productName\}/g, productName)}"`).join('\n')}
`).join('\n')}
...
[출력 형식]
설계사 응답만 출력하세요. 마크다운이나 HTML 태그 없이 순수 텍스트만 출력하세요.
제어 문자나 특수 문자를 포함하지 마세요.
**⚠️ 마침표(.)를 절대 사용하지 마세요!**
