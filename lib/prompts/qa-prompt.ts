...
4. **비교 제시 (구체적 금액과 예시 필수!)**: 2-3개 상품을 구체적 금액과 함께 비교 (보험사명 그대로 사용 가능)
   ...
   - 예시 (개선된 버전, 마침표 없이):
     ...
     * "A사는 월 3만원에 200만원 보장, B사는 월 3.5만원에 250만원 보장인데 ${productName}은 월 ${premiumInfo || '[보험료]'}원으로 250만원 보장이라 가성비가 좋아요"
